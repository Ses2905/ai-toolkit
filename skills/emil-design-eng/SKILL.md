...
description: This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when building or reviewing UI that should feel right — easing, duration, transform origin, gestures, performance, and component patterns. Distinct from review-animations (diff review), improve-animations (audit/plans), and find-animation-opportunities (missing motion).
---

# Design Engineering

Pinned from [emilkowalski/skills `emil-design-eng`](https://github.com/emilkowalski/skills/tree/85e8e2363b713506e1d5b6e07a0eb2da66be1bc3/skills/emil-design-eng) at `85e8e2363b713506e1d5b6e07a0eb2da66be1bc3` (MIT). Listing: [skills.sh](https://www.skills.sh/emilkowalski/skills/emil-design-eng) · [AI UX Playground](https://aiuxplayground.com/skills/emil-design-eng). Official CLI: `npx skills add github.com/emilkowalski/skill/blob/main/skills/emil-design-eng/SKILL.md --skill emil-design-eng`. Provenance: `SOURCE.txt`.

**In this repo:** `skills/emil-design-eng/SKILL.md`. Scoped rule: `rules/emil-design-eng.mdc` (`alwaysApply: false`). User install: `~/.cursor/skills/emil-design-eng/` via `./scripts/install-local.sh` then `./scripts/sync-user-skills.sh`. Invoke with `/emil-design-eng`. Distinct from `/review-animations` (motion diff review), `/improve-animations` (codebase audit + plans), `/find-animation-opportunities` (missing motion), `/apple-design` (Apple-style fluid UI), and `/frontend-design` (visual identity). If invoked with no question, reply only with the Initial Response quote.
