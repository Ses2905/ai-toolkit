...
# Lark shared (lark-cli)

Pinned with `lark-slides` from [larksuite/cli](https://github.com/larksuite/cli/tree/cb5a3d704379552dc61e37898e5f74798783190d/skills/lark-shared) at `cb5a3d704379552dc61e37898e5f74798783190d` (MIT). Required sibling of `skills/lark-slides`. Do not collect or print app secrets. Confirm high-risk writes.
