...
Pinned from [claude-office-skills/skills `ppt-visual`](https://github.com/claude-office-skills/skills/tree/9c4c7d5cd2813a8936bf2c9fdb174ea883b85a11/ppt-visual) at `9c4c7d5cd2813a8936bf2c9fdb174ea883b85a11` (MIT). Listing: [skills.sh](https://www.skills.sh/claude-office-skills/skills/ppt-visual) · [AI UX Playground](https://aiuxplayground.com/skills/ppt-visual). Official CLI: `npx skills add github.com/claude-office-skills/skills --skill ppt-visual`. Provenance: `SOURCE.txt`.

**In this repo:** `skills/ppt-visual/SKILL.md`. Scoped rule: `rules/ppt-visual.mdc` (`alwaysApply: false`). User install: `~/.cursor/skills/ppt-visual/` via `./scripts/install-local.sh` then `./scripts/sync-user-skills.sh`. Invoke with `/ppt-visual`. Distinct from `/ppt-master` (native editable PPTX), `/codex-ppt` (full-slide generated images), `/html-ppt` (themed HTML decks), `/slides` (Chart.js HTML), and `/guizang-ppt-skill` (magazine/Swiss HTML). This skill produces layout specs, palettes, and ASCII wireframes — it does not write `.pptx` files.
