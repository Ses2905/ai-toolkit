# Taste Skill reference (full source)

Vendored from Leonxlnx/taste-skill `skills/taste-skill/SKILL.md` at `e79ca9ec7e071eb3a3b623c4fb752e853fc3ed58` (MIT). Read this when the core skill in `SKILL.md` points here.
