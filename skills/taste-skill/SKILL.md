...
Pinned from [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill/tree/e79ca9ec7e071eb3a3b623c4fb752e853fc3ed58/skills/taste-skill) at `e79ca9ec7e071eb3a3b623c4fb752e853fc3ed58` (MIT). Upstream skill name: `design-taste-frontend`.

**In this repo:** `skills/taste-skill/SKILL.md`. Full directives, vocabulary, block library, and appendices: [reference.md](reference.md). Scoped rule: `rules/taste-skill.mdc` (`alwaysApply: false`). User install: `~/.cursor/skills/taste-skill/` via `./scripts/install-local.sh` then `./scripts/sync-user-skills.sh`. Invoke with `/taste-skill`.
...
Read [reference.md](reference.md) when you need:

- Section 2 - brief to design-system map and official packages
- Section 4 - design-engineering bias correction (type, color, motion, layout)
- Sections 5-8 - proactivity, performance, dial tech, dark mode
- Section 10 and 12 - pattern vocabulary and block-library contract
- Appendices - install commands and canonical sources

Adapt original `skills/taste-skill/blocks/` paths to this repo as `skills/taste-skill/blocks/` if you add blocks.
