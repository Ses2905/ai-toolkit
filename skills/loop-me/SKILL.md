...
Keep specs in `workflows/` in the current project. Do not invent a second skill library. If the grilling produces a reusable agent playbook rather than a personal loop, bounce it to `/add-to-library`.
