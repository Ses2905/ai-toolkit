...
Pinned with `html-diagram` from [plannotator/effective-html `design-artifact`](https://github.com/plannotator/effective-html/tree/2ac1dfecb0f2474e75260cb6d3c9b9d6d9b5062e/skills/design-artifact) at `2ac1dfecb0f2474e75260cb6d3c9b9d6d9b5062e` (MIT). Required sibling for visual register. Provenance: `SOURCE.txt`.

Do not install `@plannotator/tot` or publish unless the user asked. Do not link Google Fonts CDNs.
