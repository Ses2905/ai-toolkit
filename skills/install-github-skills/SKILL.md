...
| Product | `writing-copy`, `grill-me`, `grilling`, `to-tickets`, `handoff`, `product-strategy-session` |
...
# PM Handoff (mattpocock/skills handoff)
./scripts/install-catalog-skills.sh --preset handoff
```
