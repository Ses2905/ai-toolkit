...
Pinned from [emilkowalski/skills `apple-design`](https://github.com/emilkowalski/skills/tree/d23d7f88a2e21c9e4b1418c7abe420f5c1052ba7/skills/apple-design) at `d23d7f88a2e21c9e4b1418c7abe420f5c1052ba7` (MIT).

**In this repo:** `skills/apple-design/SKILL.md`. Scoped Cursor rule: `rules/apple-design.mdc` (`alwaysApply: false`, UI/motion globs). User install: `~/.cursor/skills/apple-design/` via `./scripts/install-local.sh` then `./scripts/sync-user-skills.sh`. Invoke with `/apple-design` when not already attached.
