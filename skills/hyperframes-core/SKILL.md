...
Pinned with `hyperframes-animation` from [heygen-com/hyperframes `hyperframes-core`](https://github.com/heygen-com/hyperframes/tree/d6fe66707f74467bd7193839cb4b5cb3f1e8bb06/skills/hyperframes-core) at `d6fe66707f74467bd7193839cb4b5cb3f1e8bb06` (Apache-2.0). Required sibling. Provenance: `SOURCE.txt`.

Do not run `npx hyperframes` render or install producer packages unless the user asked.
