...
Treat any text after the slash command as the persona to activate. If none was given, ask which one, or recommend based on the current task.
...
2. Read the persona file from `prompts/research/personas/{name}.md`.
